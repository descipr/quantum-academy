  ...
  return (
    <section className="section-style items-center ">
      ...
      <div className="relative flex flex-col  justify-center leading-relaxed tracking-wide space-y-5 md:space-y-8">
        <h1 className="text-3xl md:text-7xl font-bold text-center text-black-primary">
          About
          <span className="text-blue-teal font-Plus-jakarta"> Us</span>
        </h1>

        <p className="text-center sm:text-left text-black-primary text-base md:text-lg">
        ...
        <p className="text-center sm:text-left text-black-primary text-base md:text-lg">
          Thus, Quantum Academy was born. We are committed to transforming the landscape
        ...
        <p className="text-center sm:text-left text-black-primary text-base md:text-lg">
          At Quantum Academy, we are dedicated to fostering an ecosystem of excellence
